...
const buildRootManifestYaml = (sectionFiles: string[], profileName?: string): string => {
...
export const buildConfigBundleZip = async (config: NauthilusConfig, profileName?: string): Promise<Blob> => {
  ...
  addTextFile(zip, 'nauthilus.yml', buildRootManifestYaml(sectionFiles, profileName));
